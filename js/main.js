...
// Set up theme toggle after DOM loads
...
// Add notification animations to CSS (injected via JS)
...
console.log('%cLooking at the code? Feel free to reach out if you want to collaborate!', 'font-size: 14px; color: #475569;');
